...
def elm_dependencies():
    if not native.existing_rule("aspect_rules_js"):
        http_archive(
            ...
            url = "https://github.com/aspect-build/rules_js/releases/download/v2.9.0/rules_js-v2.8.3.tar.gz",
        )
    ...
    if not native.existing_rule("com_google_protobuf"):
        http_archive(
            ...
            urls = [
                "https://github.com/protocolbuffers/protobuf/archive/v33.2.tar.gz",
            ],
        )
