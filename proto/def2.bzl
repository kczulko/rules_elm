...
def _elm_proto_library_aspect_impl(target, ctx):
    ...
    for src in proto.direct_sources:
        ...
        output_path = "bazel-out/k8-fastbuild/bin/Proto/Com/Book/Book.elm"
...
# def _elm_proto_library_impl1(ctx):
#     output_path = "Proto/Com/Book/Bool.elm"
#     out = ctx.actions.declare_file(output_path)
#     ctx.actions.run(
#         executable = "tereferekuku",
#         arguments = [],
#         inputs = [],
#         outputs = [out],
#         # tools = [],
...
# elm_proto_library1 = rule(
#     _elm_proto_library_impl1,
#     attrs = {
#         "proto": attr.label(
#             # aspects = [_elm_proto_library_aspect],
#             mandatory = False,
...
def _elm_proto_aspect_impl1(target, ctx):
...
_elm_proto_aspect1 = aspect(
    implementation = _elm_proto_aspect_impl1,
    attrs = {
        "_protoc": attr.label(
            allow_single_file = True,
            executable = True,
...
def _elm_proto_library_rule1(ctx):
    return ctx.attr.proto[_ElmLibrary]

elm_proto_library1 = rule(
    implementation = _elm_proto_library_rule1,
    doc = """""",
    attrs = {
        "proto": attr.label(
            doc = """
